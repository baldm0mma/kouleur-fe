...
describe('Picker', () => {
  ...
  let currentPalette
  beforeEach(() => {
    currentPalette=[{hex: 'ffffff'}, {hex: 'ffffff'}, {hex: 'ffffff'}, {hex: 'ffffff'}, {hex: 'ffffff'}]
    wrapper = shallow(<Picker currentPalette={currentPalette} setCurrentPalette={jest.fn()} toggleNewPalette={jest.fn()}/>)
  })
